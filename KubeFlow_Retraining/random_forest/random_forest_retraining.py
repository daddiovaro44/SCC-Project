...
def _random_forest(args):
    ...
    rf_classifier = load("random_forest.joblib")

    # Initialize GridSearchCV
    grid_search = GridSearchCV(rf_classifier, param_grid, cv=3, scoring='accuracy', verbose=2, n_jobs=-1)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Random Forest retraining')
