...
def show_results(decision_tree_accuracy: float, decision_tree_best_param: str, 
logistic_regression_accuracy: float, logistic_regression_best_param: str, 
random_forest_accuracy: float, random_forest_best_param: str) -> None:
...
def F1pipeline():
    ...
    show_results(decision_tree_task.outputs['Accuracy'],decision_tree_task.outputs['Best_param'],
    logistic_regression_task.outputs['Accuracy'],logistic_regression_task.outputs['Best_param'],
    random_forest_task.outputs['Accuracy'],random_forest_task.outputs['Best_param'])
